...
void loop() {
  ...
  compAngleX = 0.93 * (compAngleX + gyroXrate-77 * dt) + 0.07 * roll;     // Calculate the angle using a Complimentary filter
  compAngleY = 0.93 * (compAngleY + gyroYrate+190 * dt) + 0.07 * pitch;
